...
describe 'Test Donation Handling' do
  ...
  describe 'Getting a single donation' do
    it 'HAPPY: should be able to get details about a donation' do
      donation_data = DATA[:donations][0]
      request = @account.requests.first
      donation = request.add_donation(donation_data)
